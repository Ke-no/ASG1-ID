# ASG1-ID
GitHub Link: https://github.com/Ke-no/ASG1-ID

# Design Process
As a UI/UX Designer, I will be focusing on simplifying the website, making it more classical, clean and UI friendly. The first step in revamping the website is to create a wireframe for my client to see and visualize the end product. Client also wanted to sell more products to their audiences by notifying them beforehand through pre-orders, so everyone will get a chance in purchasing their desired product.

Links for Wireframe: https://www.figma.com/design/FXqCQDDB4PUVP4K2RHxrJ4/InteractiveDevelopment_10275096J_Keno_Assg1_wireframe?node-id=0-1&t=U9fjeGU2hn3wPKrE-1
...
- News page
 1. Header for navigation of pages.
 2. banner with text "NEWS".
 3. Carousell animation text.
 4. News about the band.
 5. Footer about copyrights.
...
# Credits
Content
- Some of the contents were taken from the following website
